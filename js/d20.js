...
const QUOTES = [
  ...
  { it: "Nessuno abbandona al secondo livello perché è difficile. Lo abbandona perché è noioso.",
    en: "Nobody quits at level two because it is hard. They quit because it is boring." },
  { it: "Nei giochi si sbaglia per imparare. Al lavoro si impara a non farlo vedere.",
    en: "In games you get it wrong in order to learn. At work you learn not to let it show." },
  { it: "Il punteggio non motiva. Motiva vederlo salire per qualcosa che hai fatto tu.",
    en: "The score does not motivate. Watching it climb for something you did motivates." },
  { it: "La formazione che funziona la senti raccontare in mensa il giorno dopo.",
    en: "Training that works is the training you hear retold in the canteen the next day." },
  { it: "I valori aziendali si leggono in bacheca. La cultura si vede in chi viene promosso.",
    en: "Company values are read off the noticeboard. The culture is seen in who gets promoted." },
  { it: "Se le persone dicono quello che pensano solo all'uscita, il problema non è l'exit interview.",
    en: "If people only say what they think on the way out, the problem is not the exit interview." },
  { it: "Promuovere il miglior venditore a capo dei venditori toglie un venditore e non aggiunge un capo.",
    en: "Promoting the best salesperson to head of sales removes a salesperson and does not add a manager." },
  { it: "Chi lavora bene riceve altro lavoro. È esattamente così che lo perdete.",
    en: "Whoever works well is given more work. That is exactly how you lose them." },
  { it: "Un titolo al posto di un aumento funziona una volta sola.",
    en: "A title instead of a raise works exactly once." },
];
